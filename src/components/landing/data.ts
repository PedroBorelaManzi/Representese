...
export const industries = [
  ...
  { name: "Farmácias",      icon: PlusIcon,      image: "/assets/setor_farmacia.webp",     objectPosition: "40% 50%" },
  ...
  { name: "Outros",         icon: Zap,           image: "/assets/setor_outros.webp",       objectPosition: "60% 50%" },
];
