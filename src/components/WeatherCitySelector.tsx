        ...
        className={cn(
          compact
            ? cn(
                ...
                light ? 'bg-white/60 hover:bg-white/75 text-sky-700 shadow-lg shadow-white/50 font-bold' : 'bg-sky-50 dark:bg-sky-950/30 text-sky-600 hover:bg-sky-100 dark:hover:bg-sky-900/40'
              )
            : cn(
